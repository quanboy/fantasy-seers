...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'oracle-gradient': 'linear-gradient(135deg, #F8FAFC 0%, #F5F3FF 40%, #F8FAFC 100%)',
        'card-gradient': 'linear-gradient(145deg, #FFFFFF 0%, #F8FAFC 100%)',
        'oracle-shimmer': 'linear-gradient(90deg, transparent, rgba(167,139,250,0.06), transparent)',
